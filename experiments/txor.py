...
toolbox.register("evaluate", evaluate_txor)
...
if __name__ == "__main__":
    ...
    try:
        ...
        filename = f"txor_0.5acc_0_-2_h{HEAD_LENGTH}_s{perfect_count}_n{len(results)}_c{CROSSOVER_RATE}_m{MUTATION_RATE}_{timestamp}.json"
